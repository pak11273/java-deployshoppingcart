...
//    @Column(nullable = false, unique = true)
    ...
    public void setPrimaryemail(String primaryemail) { this.primaryemail = primaryemail.toLowerCase(); }
    ...
    public void setPasswordNoEncrypt(String password) { this.password = password; }
