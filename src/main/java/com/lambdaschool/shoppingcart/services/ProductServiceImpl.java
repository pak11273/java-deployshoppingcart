...
public class ProductServiceImpl implements ProductService
{
    ...
    public void delete(long id)
    {
        ...
        userrepos.removeUserWithNoProducts();
    }
    ...
    {
        if (product.getUsers().size() > 0)
        {
            throw new ResourceNotFoundException("Users are not updated through Products");
        }
        ;
                          ...
                          Product product)
    {
        if (product.getUsers().size() > 0)
        {
            throw new ResourceNotFoundException("Users cannot be updated through this process");
        }
